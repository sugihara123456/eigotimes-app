...
TOEICスコア${toeicScore}点レベル（${difficultyText}）の学習者向けに、「${topic}」に関連する英語学習用の練習記事を作成してください。

【重要な注意事項】
- これは英語学習のための教育教材です
- 具体的な日付や統計データは使用せず、一般的な内容にしてください
- 学習目的に適した、建設的で中立的な内容にしてください
...
記事は200-300語程度の教育的な内容で、学習者が興味を持てるような内容にしてください。JSON以外の文字は含めないでください。
`;
